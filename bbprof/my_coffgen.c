...
asection *
coff_section_from_bfd_index2 (bfd *abfd, int section_index)
{
...
long
coff_get_symtab_upper_bound2 (bfd *abfd)
{
...
long
coff_canonicalize_symtab2 (bfd *abfd, asymbol **alocation)
{
...
const char *
_bfd_coff_internal_syment_name2 (bfd *abfd,
...
_bfd_coff_read_internal_relocs2 (bfd *abfd,
				asection *sec,
				bfd_boolean cache,
...
int
coff_count_linenumbers2 (bfd *abfd)
{
...
bfd_boolean
coff_renumber_symbols2 (bfd *bfd_ptr, int *first_undef)
{
...
void
coff_mangle_symbols2 (bfd *bfd_ptr)
{
  unsigned int symbol_count = bfd_get_symcount (bfd_ptr);
  asymbol **symbol_ptr_ptr = bfd_ptr->outsymbols;
  unsigned int symbol_index;
...
bfd_boolean
coff_write_alien_symbol2 (bfd *abfd,
			 asymbol *symbol,
...
bfd_boolean
coff_write_linenumbers2 (bfd *abfd)
{
  asection *s;
...
alent *
coff_get_lineno2 (bfd *ignore_abfd ATTRIBUTE_UNUSED, asymbol *symbol)
{
...
bfd_boolean
_bfd_coff_get_external_symbols2 (bfd *abfd)
{
  size_t symesz;
  size_t size;
  void * syms;
...
const char *
_bfd_coff_read_string_table2 (bfd *abfd)
{
...
bfd_boolean
_bfd_coff_free_symbols2 (bfd *abfd)
{
...
combined_entry_type *
coff_get_normalized_symtab2 (bfd *abfd)
{
...
long
coff_get_reloc_upper_bound2 (bfd *abfd, sec_ptr asect)
{
...
asymbol *
coff_make_empty_symbol2 (bfd *abfd)
{
...
asymbol *
coff_bfd_make_debug_symbol2 (bfd *abfd,
...
void
coff_get_symbol_info2 (bfd *abfd, asymbol *symbol, symbol_info *ret)
{
...
bfd_boolean
_bfd_coff_is_local_label_name2 (bfd *abfd ATTRIBUTE_UNUSED,
			       const char *name)
{
...
bfd_boolean
coff_find_nearest_line_with_names2 (bfd *abfd,
				   asymbol **symbols,
				   asection *section,
				   bfd_vma offset,
				   struct line_sequence** seq,
				   ...
				   const struct dwarf_debug_section *debug_sections)
{
  ...
  if (coff_data (abfd)->dwarf2_find_line_info != NULL)
      ...
      else if (symbols)
	{
      ...
      if (bias
	  && _bfd_dwarf2_find_nearest_line2 (abfd, symbols, NULL, section,
					    offset + bias,
					    seq, index, functionname_ptr,
					    debug_sections,
					    &coff_data(abfd)->dwarf2_find_line_info))
...
bfd_boolean
coff_find_inliner_info2 (bfd *abfd,
...
int
coff_sizeof_headers2 (bfd *abfd, struct bfd_link_info *info)
{
  size_t size;
...
bfd_boolean
bfd_coff_set_symbol_class2 (bfd *	 abfd,
			   asymbol *	 symbol,
...
bfd_boolean
_bfd_coff_section_already_linked2 (bfd *abfd,
				  asection *sec,
...
bfd_boolean
bfd_coff_gc_sections2 (bfd *abfd ATTRIBUTE_UNUSED, struct bfd_link_info *info)
{
  bfd *sub;
...
const char *
bfd_coff_group_name2 (bfd *abfd, const asection *sec)
{
...
bfd_boolean
_bfd_coff_close_and_cleanup2 (bfd *abfd)
{
