...
const struct dwarf_debug_section dwarf_debug_sections2[] =
{
...
/* A static assertion.  */
extern int dwarf_debug_section_assert[ARRAY_SIZE (dwarf_debug_sections2)
				      == debug_max + 1 ? 1 : -1];
...
bfd_boolean
_bfd_dwarf2_slurp_debug_info2 (bfd *abfd, bfd *debug_bfd,
			      const struct dwarf_debug_section *debug_sections,
			      asymbol **symbols,
			      void **pinfo,
...
bfd_signed_vma
_bfd_dwarf2_find_symbol_bias2 (asymbol ** symbols, void ** pinfo)
{
  struct dwarf2_debug *stash;
  struct comp_unit * unit;
  htab_t sym_hash;
...
bfd_boolean
_bfd_dwarf2_find_inliner_info2 (bfd *abfd ATTRIBUTE_UNUSED,
			       const char **filename_ptr,
			       const char **functionname_ptr,
			       unsigned int *linenumber_ptr,
			       void **pinfo)
...
void
_bfd_dwarf2_cleanup_debug_info2 (bfd *abfd, void **pinfo)
{
  struct dwarf2_debug *stash = (struct dwarf2_debug *) *pinfo;
  struct comp_unit *each;
  struct dwarf2_debug_file *file;
...
asymbol *
_bfd_elf_find_function2 (bfd *abfd,
			asymbol **symbols,
			asection *section,
			bfd_vma offset,
			const char **filename_ptr,
